                ...
                Padding(
                  ...
                  child: Center(
                    child: CommonHeadlineText(
                      title: AppLocalizations.of(context)!.myFavourite,
                    ),
                  ),
                ),
                const Divider(),
                        ...
                        return Padding(
                          ...
                          child: Column(
                            children: [
                              ...
                              Text(
                                AppLocalizations.of(context)!.favouriteIsEmpty,
                                style: TextStyle(
                ...
                child: GestureDetector(
                  onTap: () async {
                    ...
                    CommonScaffoldMessenger.success(
                        context: context,
                        message: 'All Items add to cart.....');

                    CommonShowDialog.close(context: context);
                  },
                  child: CommonActionButton(
                    name: AppLocalizations.of(context)!.addAllToCart,
                  ),
                ),
              ),
            ),
